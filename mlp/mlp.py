...
for depth in range(1, 5):
    ...
    plt.xlabel("Epochs")
    plt.ylabel("Accuracy")
    plt.title(f"Classification Accuracy (Depth={depth})")
    plt.legend()
    plt.savefig(f"results/classification/acc_depth_{depth}.png")
    plt.close()
    ...
    plt.xlabel("Epochs")
    plt.ylabel("Loss")
    plt.title(f"Classification Loss (Depth={depth})")
    plt.legend()
    plt.savefig(f"results/classification/loss_depth_{depth}.png")
    plt.close()
...
cls_df.to_csv("results/classification/classification_results.csv", index=False)
...
for depth in range(1, 5):
    ...
    plt.xlabel("Epochs")
    plt.ylabel("MSE")
    plt.title(f"Regression MSE (Depth={depth})")
    plt.legend()
    plt.savefig(f"results/regression/mse_depth_{depth}.png")
    plt.close()
...
reg_df.to_csv("results/regression/regression_results.csv", index=False)
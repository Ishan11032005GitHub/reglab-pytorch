...
BASE_DIR = "results/gd_early_stopping"
...
# ================= CLASSIFICATION =================
print("\nCLASSIFICATION (GD + EARLY STOPPING)")
...
print("\nAll GD + Early Stopping experiments finished. Results saved in:", BASE_DIR)
...
for lam in L2_LAMBDAS:
    ...
    cls_dir = f"{BASE_DIR}/classification/lambda_{lam}"
    ...
    for depth in range(1, 5):
        ...
        plt.xlabel("Epochs")
        plt.ylabel("Accuracy")
        plt.title(f"Classification Accuracy (Depth={depth}, λ={lam})")
        plt.legend()
        ...
        plt.xlabel("Epochs")
        plt.ylabel("Loss")
        plt.title(f"Classification Loss (Depth={depth}, λ={lam})")
        plt.legend()
...
for lam in L2_LAMBDAS:
    ...
    reg_dir = f"{BASE_DIR}/regression/lambda_{lam}"
    ...
    for depth in range(1, 5):
        ...
        plt.xlabel("Epochs")
        plt.ylabel("MSE")
        plt.title(f"Regression MSE (Depth={depth}, λ={lam})")
        plt.legend()
        ...
        plt.xlabel("Epochs")
        plt.ylabel("Loss")
        plt.title(f"Regression Loss (Depth={depth}, λ={lam})")
        plt.legend()
        plt.savefig(f"{reg_dir}/loss_depth_{depth}.png")
        plt.close()

...
# CLASSIFICATION (SGD)
print("\nCLASSIFICATION (SGD - sample-wise)")
...
for depth in range(1, 5):
    ...
    plt.xlabel("Epochs")
    plt.ylabel("Accuracy")
    plt.title(f"SGD Classification Accuracy (Depth={depth})")
    plt.legend()
    ...
    plt.xlabel("Epochs")
    plt.ylabel("Loss")
    plt.title(f"SGD Classification Loss (Depth={depth})")
    plt.legend()
...
for depth in range(1, 5):
    ...
    plt.xlabel("Epochs")
    plt.ylabel("MSE")
    plt.title(f"SGD Regression MSE (Depth={depth})")
    plt.legend()
...
print("\nAll SGD experiments finished. Results saved in:", BASE_DIR)